...
import { Cart, CartItemType, Coupon } from '../../shared/models/cart';
...
export class CartService {
  ...
  async addItemToCart(item: CartItemType | Product, quantity = 1) {
  ...
  private addOrUpdateItem(items: CartItemType[], item: CartItemType, quantity: number) {
  ...
  private mapProductToCartItem(product: Product): CartItemType {
    return {
